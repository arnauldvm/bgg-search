...
4. **Execute phases** — for each phase:
   - 4.1 Propose a detailed phase plan (decomposed into successive modifications). Store in `PLAN.md` on the phase branch.
   - 4.2 Review and adapt the phase plan.
   - 4.3 Implement each modification following the **Development workflow** below.
